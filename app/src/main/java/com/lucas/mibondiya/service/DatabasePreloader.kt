...
class DatabasePreloader @Inject constructor(
    ...
    suspend fun preloadDataIfNeeded() {
        ...
        if (!hasHorarios) {
            ...
            empresaDao.insert(Empresa(1, "Fono Bus", R.drawable.fonobus_te_lleva))
            horarioDao.insert(
                Horario(0, "13:30", "15:30", 1, 1, 2, "Dean Funes", "Horario 1"),
                Horario(0, "14:30", "15:30", 1, 2, 1, "Dean Funes", "Horario 2")
            )
        }
    }
}
